...
const PATTERNS = [
  { name: "Nhật Thực 🌘",
    map: [                 // 5 đảo ngầm: 4 khối so le + 1 tháp khít (góc dưới trái)
      "............",
      ".333....333.",
      ".333....333.",
      "............",
  ...
  { name: "Trái Tim 💗",
    map: [                 // 2 thùy + 2 má (tháp khít) + sống thân + đuôi
      "............",
      ".5555..5555.",
      ".5555..5555.",
      "..66....66..",
  ...
  { name: "Pháo Đài 🏰",
    map: [                 // 4 tháp khít nhô khỏi mái + 2 cánh hông + sảnh giữa so le
      ".55......55.",
      ".55......55.",
      "............",
      "44..4444..44",
  ...
  { name: "Bươm Bướm 🦋",
    map: [                 // 4 cánh so le + thân dọc ở giữa
      ".444....444.",
      ".444....444.",
      ".....55.....",
      ".....55.....",
  ...
  { name: "Chiếc Nhẫn 💍",
    map: [                 // 7 đảo nhỏ quanh viên đá tháp khít ở giữa
      "............",
      ".....44.....",
      ".....44.....",
      ".44......44.",
  ...
  { name: "La Bàn 🧭",
    map: [                 // 4 đảo 4 hướng + kim tháp khít ở giữa
      "....4444....",
      "....4444....",
      "............",
      "44........44",
...
function generateLevel(level) {
  ...
  for (let y = 0; y < gridH; y++) {
    ...
    for (let x = 0; x < gridW; x++) {
      ...
      let h = ch === "." ? 0 : +ch;
      if (h >= 2) h = Math.min(h + cfg.tier, 8);
      hMap[y].push(h);
